...
const beliefs = [
  ...
  },
  {
    ...
    confidence: 76,
    status: "confirmed",
    evidence: "You rejected two direct-response captions during archive review.",
  },
];

const memoryEvents = [
  { owner: "Strategist", time: "Today · 09:46", title: "Experiment 04 approved", detail: "You approved the participatory premise without changing the restrained voice." },
  ...
  return (
    <WorkspaceShell active="Memory" pageName="Memory">
      <div className="surface memory-surface">
        <section className="page-hero memory-hero"><div><h1>Your creator context</h1><p>Preferences, audience patterns, test results, and approval rules used by every role in this workspace.</p><div className="hero-meta"><span className="status-chip status-chip--memory">Shared across 4 roles</span><span>18 sourced entries</span><span>Updated today</span></div></div></section>
        ...
        <div className="memory-grid">
          ...
          <section className="boundary-card" aria-labelledby="boundary-title">
            ...
            <div className="boundary-split"><span><Check weight="bold" /> Team can do</span><p>Study sample evidence · draft a test · prepare assets · explain results</p><span><WarningCircle /> You decide</span><p>Publish · contact people · spend money · grant account access</p></div>
          </section>
